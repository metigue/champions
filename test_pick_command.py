...
def test_pick_command():
    """Test the pick command with various test cases"""
    handler = MockCommandHandler()
    
    print("=== Test Case 1: !pick 2 nico, karolina, arnim zola, red skull, thor ===")
    result = handler.pick_champions_for_battlegrounds(2, "nico, karolina, arnim zola, red skull, thor")
    print(result)
    
    print("\n=== Test Case 2: !pick 3 random champions ===")
    result = handler.pick_champions_for_battlegrounds(3, "spider-man, hulk, captain america, iron man, thor, hawkeye")
    print(result)
    
    print("\n=== Test Case 3: !pick 5 champions with mix of rated and unrated ===")
    result = handler.pick_champions_for_battlegrounds(5, "wolverine, black widow, dr. strange, gamora, ant-man, wasp, falcon, winter soldier")
    print(result)
    
    print("\n=== Test Case 4: !pick 4 champions with mostly high-rated ===")
    result = handler.pick_champions_for_battlegrounds(4, "nico minoru, tigra, shathra, juggernaut, werewolf, kushala")
    print(result)
